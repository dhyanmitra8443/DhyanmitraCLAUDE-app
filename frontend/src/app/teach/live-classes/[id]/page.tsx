...
export default async function InstructorLiveClassDetailPage({ params }: { params: Promise<{ id: string }> }) {
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <div className="mt-1 flex items-center gap-2">
            ...
            {liveClass.courseId && (
              <Link href={`/teach/courses/${liveClass.courseId}`} className="text-muted-foreground text-sm underline underline-offset-2">
                View course
              </Link>
            )}
          </div>
